...
static void read_Context_struct(erpc::Codec *codec, Context *data) {
  ...
  data->curr = static_cast<State>(_tmp_local_i32);
...
DisplayInterface_service::DisplayInterface_service(
    DisplayInterface_interface *_DisplayInterface_interface)
...
erpc_status_t DisplayInterface_service::handleInvocation(
    uint32_t methodId, uint32_t sequence, Codec *codec,
    MessageBufferFactory *messageFactory, Transport *transport) {
  erpc_status_t erpcStatus;
  switch (methodId) {
  case DisplayInterface_interface::m_sendDisplayCommandId: {
    erpcStatus =
        sendDisplayCommand_shim(codec, messageFactory, transport, sequence);
    break;
  }
...
erpc_status_t DisplayInterface_service::sendDisplayCommand_shim(
    Codec *codec, MessageBufferFactory *messageFactory, Transport *transport,
    uint32_t sequence) {
